  ...
  return (
    <Container>
      <div className="carousel-container">
        <button className="button-left" onClick={sliderRef?.slickPrev}>
          <FaChevronLeft />
        </button>
        <Slide settings={settings} slides={slides} sliderRef={setSliderRef} />
        <button className="button-right" onClick={sliderRef?.slickNext}>
          <FaChevronRight />
        </button>
      </div>
    </Container>
